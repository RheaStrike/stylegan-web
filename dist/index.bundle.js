      ...
      [
        _c("header", [
          ...
          _c(
            ...
            [
              _c("v-select", {
                attrs: { label: "title", options: _vm.latents_directions },
                model: {
                  value: _vm.selected,
                  callback: function($$v) {
                    _vm.selected = $$v;
        ...
        _c("aside", [
          ...
          _vm._v(" "),
          _vm.shownLatentDirections
            ? _c(
                "ol",
                _vm._l(_vm.shownLatentDirections, function(direction, index) {
                  return _c("li", { key: index }, [
                    _c("input", {
                      directives: [
                        {
                          ...
                          expression: "direction.normalized",
                          modifiers: { lazy: true }
                        }
                      ],
                      ...
                      domProps: { value: direction.normalized },
                      on: {
                        change: function($event) {
                          return _vm.$set(
                            direction,
